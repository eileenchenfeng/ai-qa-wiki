# Day 65｜每日 AI 学习笔记｜Day 65：AI Agent 性能压测实战（Locust + k6 + Agent 场景）

- 📅 日期：2026-06-19
- 🏷️ 标签：learning-notes, AI, QA, performance-testing, locust, k6, load-testing, agent
- 📄 原文：[`raw/2026-06-19-day65-agent-load-testing-locust-k6.md`](../../raw/2026-06-19-day65-agent-load-testing-locust-k6.md)
