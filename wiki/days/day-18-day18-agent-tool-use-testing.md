# Day 18｜每日 AI 学习笔记｜Day 18：Agent 工具调用（Tool Use / Function Calling）测试策略

- 📅 日期：2026-05-03
- 🏷️ 标签：learning-notes
- 📄 原文：[`raw/2026-05-03-day18-agent-tool-use-testing.md`](../../raw/2026-05-03-day18-agent-tool-use-testing.md)
